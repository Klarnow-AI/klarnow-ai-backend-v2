  ...
  return (
    <>
      ...
      <motion.aside
        ...
        transition={{ duration: 0.25, ease: "easeInOut" }}
        className="hidden lg:flex fixed left-4 top-4 bottom-4 rounded-2xl border border-border/40 bg-card/70 backdrop-blur-2xl flex-col shadow shadow-black/5 dark:shadow-black/15 overflow-hidden z-20"
      >
        <SidebarContent
          variant="desktop"
          collapsed={collapsed}
